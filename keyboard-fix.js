...
(() => {
  ...
  function loadModernStudio() {
    [
      ["modernStudioCoreCss", "studio-core.css?v=1"],
      ["modernStudioEditorCss", "studio-editor.css?v=1"],
      ["modernStudioResponsiveCss", "studio-responsive.css?v=1"]
    ].forEach(([id, href]) => {
    ...
    [
      ["modernStudioShell", "studio-shell.js?v=1"],
      ["modernStudioTimeline", "studio-timeline.js?v=1"],
      ["modernStudioHistory", "studio-history.js?v=1"]
    ].forEach(([id, src]) => {
      if (document.getElementById(id)) return;
