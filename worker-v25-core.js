...
import {kidsStoryGenerate,kidsScenePlan} from "./v41-kids-story-resilient.js";
...
if(u.pathname==="/api/health")return json({ok:true,build:"v41-resilient-story-topic-lock",ai:!!env.AI?.run,pollinations:!!env.POLLINATIONS_API_KEY,geminiTts:!!env.GEMINI_API_KEY,elevenlabs:!!env.ELEVENLABS_API_KEY,tts:!!(env.GEMINI_API_KEY||env.ELEVENLABS_API_KEY),youtube:!!(env.YOUTUBE_CLIENT_ID&&env.YOUTUBE_CLIENT_SECRET)});
