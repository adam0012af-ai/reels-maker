...
async function injectAutomation(response){
  ...
  if(!html.includes("mobile-home-v1.css"))html=html.replace("</head>",'<link rel="stylesheet" href="mobile-home-v1.css?v=1"></head>');
  if(!html.includes("mobile-nav-v2.css"))html=html.replace("</head>",'<link rel="stylesheet" href="mobile-nav-v2.css?v=1"></head>');
  ...
  if(!html.includes("mobile-home-v1.js"))html=html.replace("</body>",'<script src="mobile-home-v1.js?v=1"></script></body>');
  if(!html.includes("mobile-nav-v2.js"))html=html.replace("</body>",'<script src="mobile-nav-v2.js?v=1"></script></body>');
  const headers=new Headers(response.headers);headers.delete("content-length");headers.set("content-type","text/html; charset=utf-8");headers.set("cache-control","no-store, no-cache, must-revalidate");headers.set("x-rm-autocontent","v4-mobile-nav");
